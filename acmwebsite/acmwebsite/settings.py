# Django settings for acmwebsite project.
import os.path
...
STATIC_ROOT = '/srv/acm/site/static/public'
...
STATICFILES_DIRS = (
    ...
    "/srv/acm/site/static/public",
    
)

BOWER_COMPONENTS_ROOT = os.path.join(PROJECT_ROOT, 'static/lib')
...
SECRET_KEY = 'xna!8ph9x(=^w5+v0$8^@7m5pa5m$u4$g+hx4zx1zywlrmtexj'
